...
//     const wrapper = new YjsWrapper(initialObject, map);
...
//       const wrapper = new YjsWrapper<{ text: string }>(starterObject, map);
...
//       const wrapper = new YjsWrapper(initialArray, array);
